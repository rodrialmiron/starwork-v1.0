...
const DetailClassesSuper = ({ classes, setIsOpen }) => {
  return (
    <>
      <div className="w-[800px] min-h-[400px] p-2 bg-gray-200 rounded-xl shadow-md dark:bg-gray-800">
        <h2 className="dark:text-white text-2xl flex mt-2 justify-center">
          CLASES
        </h2>
        <div className="flex justify-end">
          <button
            title="Cerrar"
            onClick={setIsOpen}
            className="text-gray-100 mr-8 -mt-8 rounded-md bg-red-500 hover:bg-red-700 transition duration-200 font-semibold -py-1 px-2"
          >
...
export default DetailClassesSuper;
