                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:180px">
                                                                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://fifmgjf.stripocdn.email/content/guids/CABINET_f7ad66d6276577d3094951879fe92721fae4e4830cec3af3e833f059acee5668/images/icono.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="180"></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="right" style="padding:0;Margin:0" class="esd-text">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:30px;color:#333333;font-size:20px"><strong>¡Hola, ${firstName} ${lastName}!&nbsp; &nbsp;</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" style="padding:0;Margin:0" class="esd-text">
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"><strong>¡Te invitamos a nuestra próxima clase!</strong></p>
                                                                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Curso: <b>${courseName}</b><br>Titulo de la clase: <strong>${classTitle}</strong><br>Mensaje: <strong>${classMessage}</strong><br>Enlace para unirte a la clase: ${classLink}&nbsp;</p>
